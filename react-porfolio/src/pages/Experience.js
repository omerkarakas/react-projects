        ...
        <div className="experience">
            <VerticalTimeline lineColor="darkblue">
                ...
                >
                    ...
                    <h5 className="vertical-timeline-element-subtitle subtitle">Javascript/C#/AWS Developer</h5>
                    <h5 className="vertical-timeline-element-subtitle subtitle">Sofia, Bulgaria</h5>
                    <p>C#, AWS, AWS Lambda, AWS Step Functions </p>
                </VerticalTimelineElement>
                ...
                <VerticalTimelineElement
                    ...
                    h5="omer"
                >
                    <h3 className="vertical-timeline-element-title title">Pippe Labs</h3>
                    <h5 className="vertical-timeline-element-subtitle subtitle">Contractor, Front End Developer</h5>
                ...
                <VerticalTimelineElement
                    ...
                    h5="omer"
                >
                    <h3 className="vertical-timeline-element-title title">Turkish Agricultural Credit Cooperatives</h3>
                ...
                >
                    ...
                    <h5 className="vertical-timeline-element-subtitle subtitle">Co-Founder, Lead Software Engineer</h5>
                    <h5 className="vertical-timeline-element-subtitle subtitle">Ankara, Turkey</h5>
                    <p>
                        Javascript, TypeScript, React.js, React native, Amazon Web Services (AWS), Spring/Java backend
                        development, Java Vaadin, Web Services (REST, SOAP), PostgreSQL
                    </p>
                </VerticalTimelineElement>
                ...
                >
                    ...
                    <h5 className="vertical-timeline-element-subtitle subtitle">Web Development Instructor</h5>
                    <h5 className="vertical-timeline-element-subtitle subtitle">Ankara, Turkey</h5>
                    <p>
                        JavaScript, React.js, HTML, CSS, Java, Hibernate, Spring (Framework, MVC, AOP, REST, Security),
                        Spring Boot
                    </p>
                </VerticalTimelineElement>
                ...
                <VerticalTimelineElement
                    ...
                    icon={<WorkIcon />}
                >
                    <h3 className="vertical-timeline-element-title title">Social Security Institution, VBT Software</h3>
                ...
                >
                    ...
                    <h5 className="vertical-timeline-element-subtitle subtitle">Ankara, Turkey</h5>
                    <p>
                        Javascript, Frontend JS, Angular.js, Ionic, Cordova, AWS EC2, Java Vaadin Framework, Backend
                        Spring Java Development, Web Services (REST), PostgreSQL
                    </p>
                </VerticalTimelineElement>
                ...
                >
                    ...
                    <h5 className="vertical-timeline-element-subtitle subtitle">Ankara, Turkey</h5>
                    <p>
                        Java, Backend Spring Java Development, Web Services (SOAP), Swing, Oracle Database, SQL, PL/SQL
                    </p>
                </VerticalTimelineElement>
                ...
                <VerticalTimelineElement
                    ...
                    icon={<SchoolIcon />}
                >
                    <h3 className="vertical-timeline-element-title title">Middle East Technical University</h3>
                    <h5 className="vertical-timeline-element-subtitle subtitle">Ankara, Turkey</h5>
